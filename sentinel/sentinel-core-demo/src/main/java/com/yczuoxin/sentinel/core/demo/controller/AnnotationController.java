...
public class AnnotationController {
    ...
    @SentinelResource(entryType = EntryType.OUT, value = "hello", blockHandler = "exceptionHandler",fallback = "fallback")
    ...
    public String exceptionHandler(Long costTime, BlockException ex) {
        ex.printStackTrace();
        System.out.printf("[%s] exceptionHandler costs time: %d\n", Thread.currentThread().getName(), costTime);
